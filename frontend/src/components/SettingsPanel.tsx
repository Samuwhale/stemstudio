...
const STORAGE_PATH_HINT = 'Choose an empty or StemStudio-managed folder. Blank, broad, system, and overlapping paths are rejected.'
      ...
      {view === 'storage' ? (
        <form className="import-form" onSubmit={handleSubmit}>
          ...
          <section className="storage-panel-block">
            ...
            {storageOverviewError ? (
              <p className="field-error" role="alert">
                Could not load workspace usage: {storageOverviewError}
              </p>
            ) : !storageOverview ? (
              <div className="skeleton-stack">
                <Skeleton height={36} />
          ...
          <details className="storage-panel-block storage-paths-collapsible">
            ...
            <p className="field-hint">
              Use separate empty folders or folders already managed by StemStudio. Cleanup actions delete contents inside these paths.
            </p>
