    ...
    >
      <div className="overlay-panel overlay-panel-wide" ref={panelRef} tabIndex={-1}>
        <header className="overlay-head">
          ...
          <button ref={closeButtonRef} type="button" className="button-secondary" disabled={busy} onClick={onClose}>
            Close
          </button>
        </header>
        ...
        <div className="overlay-body">
          {rows.length === 0 ? (
            ...
            <div className="batch-stems">
              ...
              {!stemCreationReady ? (
                <p className="batch-stems-reason">{stemCreationBlockedReason}</p>
              ) : (
              ...
              <div className="import-footer">
                {!stemCreationReady ? (
                  <span>{stemCreationBlockedReason}</span>
